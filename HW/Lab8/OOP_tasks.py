...
#         self.name, self.student_id, self.courses = name, student_id, courses
...
#         print(f'Course: {",".join(self.courses)}')
...
#         self.account_number, self.__balance = account_number, __balance
